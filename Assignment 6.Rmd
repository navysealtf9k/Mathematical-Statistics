...
For x = 25, 35, 50,
(i) obtain the local constant kernel estimator of βx, i.e., p = 0. (ii) obtain the local linear kernel estimator of βx, i.e., p = 1.
(iii) obtain the local quadratic kernel estimator of βx, i.e., p = 2. Report these vectors. What are your predicted values at these x?
